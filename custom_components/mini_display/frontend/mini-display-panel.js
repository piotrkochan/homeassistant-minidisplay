...
var e = globalThis, t = e.ShadowRoot && (e.ShadyCSS === void 0 || e.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, n = Symbol(), r = /* @__PURE__ */ new WeakMap(), i = class {
	...
	return a(t);
})(e) : e, { is: l, defineProperty: u, getOwnPropertyDescriptor: d, getOwnPropertyNames: f, getOwnPropertySymbols: p, getPrototypeOf: ee } = Object, te = globalThis, m = te.trustedTypes, ne = m ? m.emptyScript : "", re = te.reactiveElementPolyfillSupport, h = (e, t) => e, g = {
	toAttribute(e, t) {
		switch (t) {
			case Boolean:
				e = e ? ne : null;
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[h("elementProperties")] = /* @__PURE__ */ new Map(), v[h("finalized")] = /* @__PURE__ */ new Map(), re?.({ ReactiveElement: v }), (te.reactiveElementVersions ??= []).push("2.1.2");
//#endregion
//#region node_modules/lit-html/lit-html.js
var y = globalThis, ae = (e) => e, b = y.trustedTypes, oe = b ? b.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, se = "$lit$", x = `lit$${Math.random().toFixed(9).slice(2)}$`, ce = "?" + x, le = `<${ce}>`, S = document, C = () => S.createComment(""), ue = (e) => e === null || typeof e != "object" && typeof e != "function", w = Array.isArray, de = (e) => w(e) || typeof e?.[Symbol.iterator] == "function", fe = "[ 	\n\f\r]", T = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pe = /-->/g, me = />/g, E = RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`, "g"), he = /'/g, ge = /"/g, _e = /^(?:script|style|textarea|title)$/i, ve = (e) => (t, ...n) => ({
	_$litType$: e,
	strings: t,
	values: n
...
var N = class {
	...
	_$AI(e, t = this) {
		e = M(this, e, t), ue(e) ? e === A || e == null || e === "" ? (this._$AH !== A && this._$AR(), this._$AH = A) : e !== this._$AH && e !== k && this._(e) : e._$litType$ === void 0 ? e.nodeType === void 0 ? de(e) ? this.k(e) : this._(e) : this.T(e) : this.$(e);
	}
	O(e) {
	...
	_(e) {
		this._$AH !== A && ue(this._$AH) ? this._$AA.nextSibling.data = e : this.T(S.createTextNode(e)), this._$AH = e;
	}
	$(e) {
	...
	_$AI(e, t = this, n, r) {
		...
		if (i === void 0) e = M(this, e, t, 0), a = !ue(e) || e !== this._$AH && e !== k, a && (this._$AH = e);
		else {
			let r = e, o, s;
			for (e = i[0], o = 0; o < i.length - 1; o++) s = M(this, r[n + o], t, o), s === k && (s = this._$AH[o]), a ||= !ue(s) || s !== this._$AH[o], s === A ? e = A : e !== A && (e += (s ?? "") + i[o + 1]), this._$AH[o] = s;
		}
		a && !r && this.j(e);
	}
	j(e) {
	...
	B: we,
	F: De
}, ke = y.litHtmlPolyfillSupport;
ke?.(Se, Ce), (y.litHtmlVersions ??= []).push("3.3.3");
var Ae = (e, t, n) => {
...
var Fe = [
  ...
  `;
	...
	render() {
		let e = this.unit ?? 1;
		return D`<label for="duration">${this.label}</label><div class="field">
      ...
      <div class="units" role="radiogroup" aria-label="Time unit">
        ${this.unitOptions.map((t) => D`<label title=${t.name}><input type="radio" name="unit" aria-label=${t.name}
...
z([L({ type: Number })], B.prototype, "seconds", void 0), z([L({ type: Number })], B.prototype, "min", void 0), z([L({ type: Number })], B.prototype, "max", void 0), z([L()], B.prototype, "label", void 0), z([L({ type: Boolean })], B.prototype, "subsecond", void 0), z([R()], B.prototype, "unit", void 0), B = z([I("mini-display-duration-field")], B);
//#endregion
...
var Ie = class extends F {
  ...
  `;
	...
	render() {
      ...
      ${e ? D`<select aria-label="Marquee effect"
...
z([L({ attribute: !1 })], Ie.prototype, "value", void 0), z([L({ type: Boolean })], Ie.prototype, "defaultEnabled", void 0), Ie = z([I("mini-display-marquee-field")], Ie);
//#endregion
//#region src/types.ts
var Le = (e = "number") => e === "weather" ? {
	type: e,
	source: "",
	weather: {
		period: "current",
...
var { I: Ke } = Oe, qe = (e) => e.strings === void 0, Je = {}, Ye = (e, t = Je) => e._$AH = t, V = {
	ATTRIBUTE: 1,
	CHILD: 2,
	PROPERTY: 3,
	BOOLEAN_ATTRIBUTE: 4,
	...
	for (let e of n) e._$AO?.(t, !1), Qe(e, t);
	return !0;
}, $e = (e) => {
	let t, n;
	do {
...
function tt(e) {
	this._$AN === void 0 ? this._$AM = e : ($e(this), this._$AM = e, et(this));
}
function nt(e, t = !1, n = 0) {
	let r = this._$AH, i = this._$AN;
	if (i !== void 0 && i.size !== 0) {
		if (t) {
			if (Array.isArray(r)) for (let e = n; e < r.length; e++) Qe(r[e], !1), $e(r[e]);
			else r != null && (Qe(r, !1), $e(r));
		} else Qe(this, e);
	}
}
var rt = (e) => {
	e.type == V.CHILD && (e._$AP ??= nt, e._$AQ ??= tt);
}, it = class extends Ze {
	constructor() {
	...
	_$AO(e, t = !0) {
		e !== this.isConnected && (this.isConnected = e, e ? this.reconnected?.() : this.disconnected?.()), t && (Qe(this, e), $e(this));
	}
	setValue(e) {
	...
	disconnected() {}
	reconnected() {}
}, at = /* @__PURE__ */ new WeakMap(), ot = Xe(class extends it {
	render(e) {
		return A;
	}
	update(e, [t]) {
		let n = t !== this.G;
		return n && this.rt(void 0), (n || this.lt !== this.ct) && (this.G = t, this.ht = e.options?.host, this.rt(this.ct = e.element)), A;
	}
	rt(e) {
		if (this.G !== void 0) {
			if (this.isConnected || (e = void 0), typeof this.G == "function") {
				let t = this.ht ?? globalThis, n = at.get(t);
				n === void 0 && (n = /* @__PURE__ */ new WeakMap(), at.set(t, n)), n.get(this.G) !== void 0 && this.G.call(this.ht, void 0), n.set(this.G, e), e !== void 0 && this.G.call(this.ht, e);
			} else this.G.value = e;
		}
	}
	get lt() {
...
}), st = (e, t = !1) => (e?.marquee ?? t) && (e?.textFlow ?? "default") === "default", ct = /* @__PURE__ */ new WeakMap();
...
z([L()], ut.prototype, "label", void 0), z([L()], ut.prototype, "value", void 0), z([L({
	type: Boolean,
	reflect: !0
})], ut.prototype, "disabled", void 0), customElements.get("mini-display-color-field") || customElements.define("mini-display-color-field", ut);
//#endregion
...
z([L({ attribute: !1 })], U.prototype, "graph", void 0), z([L()], U.prototype, "source", void 0), z([L({ attribute: !1 })], U.prototype, "series", void 0), z([L({ type: Number })], U.prototype, "width", void 0), z([L({ type: Number })], U.prototype, "height", void 0), U = z([I("mini-display-graph-preview")], U);
//#endregion
  ...
  `;
	...
	render() {
		let e = this.card?.weather ?? {}, t = e.fields ?? [
			...
			"condition",
			"temperature"
		], n = e.period === "current" ? 1 : e.count ?? 1, r = e.language === "pl" ? pt : ft;
		return D`${Array.from({ length: n }, (n, i) => {
			let a = this.data?.values[this.data.weather.sources[i]], o = a?.available, s = o ? a.state.split("|") : [], c = o ? Number(s[0]) : 15, l = this.data?.weather.temperatureUnit ?? "", u = this.data?.weather.windUnit ?? "", d = (e, n) => t.includes(e) ? D`<div class="line ${e}" title=${n}>${n}</div>` : A;
			return D`<div
        class="cell ${e.layout ?? "vertical"} ${t.length === 1 && t[0] === "icon" ? "solo" : ""}"
      >
        ${t.includes("icon") ? D`<ha-icon icon=${`mdi:weather-${dt[c] ?? dt[15]}`} style=${e.iconStyle === "mono" ? "" : `color:${c === 11 ? "#ffff00" : c === 0 ? "#d3d3d3" : c === 4 || c === 5 ? "#ffa500" : "#00ffff"}`}></ha-icon>` : A}
        ${t.some((e) => e !== "icon") ? D`<div class="lines">
...
z([L({ attribute: !1 })], mt.prototype, "hass", void 0), z([L({ attribute: !1 })], mt.prototype, "card", void 0), z([L()], mt.prototype, "signature", void 0), z([R()], mt.prototype, "data", void 0), mt = z([I("mini-display-weather-preview")], mt);
//#endregion
//#region src/visibility.ts
var ht = /* @__PURE__ */ new Set(["unknown", "unavailable"]), gt = /* @__PURE__ */ new Set([
	"range",
	"number_equals",
	"number_not_equals",
	"greater_than",
...
function _t(e, t, n) {
	let r = t.source === "card" ? n?.source ? e?.states[n.source]?.state : n?.type === "text" ? n.text : void 0 : t.entity ? e?.states[t.entity]?.state : void 0, i = r !== void 0 && !ht.has(r);
	if (t.operator === "available") return i;
	if (t.operator === "unavailable") return !i;
	if (!i) return !1;
	if (gt.has(t.operator)) {
		let e = Number(r);
...
function vt(e, t, n) {
	...
	let r = new Map(t.rules.map((e) => [e.id, e])), i = (t) => {
		let a = t.type === "rule" ? _t(e, r.get(t.ruleId), n) : t.operator === "and" ? t.children.every(i) : t.children.some(i);
		return t.negate ? !a : a;
	};
...
}, bt = /* @__PURE__ */ new Map(), xt = (e) => yt[e]?.height ?? e;
function W(e, t) {
	let n = yt[t];
	if (!n) return 0;
	let r = [...e], i = 0;
...
var St = class extends F {
	...
	render() {
		return D`<canvas aria-hidden="true" width=${Math.max(1, W(this.text, this.size))} height=${xt(this.size)}></canvas>`;
	}
	updated() {
		this.paint();
	}
	async paint() {
		let e = ++this.generation, t = yt[this.size];
		if (!t) return;
		bt.has(this.size) || bt.set(this.size, new Promise((e, n) => {
			let r = new Image();
			r.onload = () => e(r), r.onerror = n, r.src = t.atlas;
		}));
		let n = await bt.get(this.size);
...
z([L()], St.prototype, "text", void 0), z([L({ type: Number })], St.prototype, "size", void 0), z([L()], St.prototype, "color", void 0), customElements.define("mini-display-firmware-text", St);
//#endregion
...
`, wt = class {
	valueFontSize(e, t, n, r) {
		let i = [
			...
			36,
			48
		], a = i.map(xt), o = e.valueStyle?.fontSize ?? "auto", s = o === "small" ? 0 : o === "medium" ? 1 : o === "large" ? 2 : o === "xlarge" || r >= 58 ? 3 : r >= 42 ? 2 : +(r >= 28);
		if ((e.valueStyle?.textFlow ?? "default") !== "default") return i[o === "auto" ? Math.min(s, 1) : s];
		for (; s > 0 && !(a[s] <= r && (st(e.valueStyle) || W(t, i[s]) <= n - 6));) --s;
		return i[s];
	}
	fontLineHeight(e) {
		return xt(e);
	...
	titleFontSize(e, t, n, r, i) {
		...
		for (let i of l) if (!(this.fontLineHeight(i) > r) && (st(e.titleStyle, !0) || W(t, i) <= n - 6)) return i;
		return s ? 13 : 18;
	}
	...
	constructor(e) {
		this.host = e, this.down = (e) => {
			...
			let d = u.rows.map((e, t) => {
				let n = vt(this.hass, e.visibility);
				return {
					rowIndex: t,
					cards: e.cards.map((e, t) => ({
						cardIndex: t,
						hidden: !n || !vt(this.hass, e.visibility, e)
	...
	pageDropzones() {
      ...
      <div class="page-dropzones">
        ${t.map((e) => D`<div class="page-dropzone ${e} ${this.dragTarget === e ? "active" : ""}"><ha-icon icon=${n[e]}></ha-icon></div>`)}
      </div>`;
	}
}, G = class extends F {
	constructor(...e) {
		super(...e), this.assets = [], this.page = 0, this.autoRotate = !1, this.width = 240, this.height = 240, this.refreshRateHz = 60, this.displayId = "", this.interactive = !1, this.showHidden = !1, this.now = /* @__PURE__ */ new Date(), this.autoPage = 0, this.pageShownAt = Date.now(), this.historySeries = [], this.historyPending = !1, this.historyFetched = 0, this.interaction = new Tt(this), this.typography = new wt();
	}
	static {
		this.styles = Ct;
	}
	...
	render() {
		...
		if (r.length === 0 && !n) return D`<div class="screen-frame" style=${t}>
        <div class="screen">
		...
		let i = !n && !!(e.title && e.showTitle !== !1), a = e.titlePosition ?? "top", o = e.style?.background ?? "", s = (H[o] ?? o) || "#000000", c = e.titleStyle?.background ?? "", l = e.titleStyle?.foreground ?? "", u = (H[c] ?? c) || s, d = (H[l] ?? l) || "#ffffff", f = e.titleStyle?.fontSize ?? "small", p = {
			...
			xlarge: 48,
			auto: 18
		}[f], te = i && (a === "top" || a === "bottom") ? p : 0, m = i && (a === "left" || a === "right") ? p : 0, ne = this.width - 12 - m, re = this.height - 12 - te - 4 * Math.max(0, r.length - 1), h = r.reduce((e, t) => e + (t.row.weight ?? 1), 0) || 1, g = i ? a === "top" ? `top:${p + 6}px;right:6px;bottom:6px;left:6px` : a === "bottom" ? `top:6px;right:6px;bottom:${p + 6}px;left:6px` : a === "left" ? `top:6px;right:6px;bottom:6px;left:${p + 6}px` : `top:6px;right:${p + 6}px;bottom:6px;left:6px` : "inset:6px", _ = this.imageUrl(e.backgroundImage), ie = `${a === "top" || a === "bottom" ? `height:${p}px` : `width:${p}px`};background:${u};color:${d};font-size:${ee}px`;
		return D`<div class="screen-frame" style=${t}>
      <div
        class="screen"
        style=${`background-color:${s};${_ ? `background-image:url(${_});background-size:cover;background-position:center` : ""}`}
      >
        ${i ? D`<div
        ...
        <div class="page-content ${n ? "free-layout" : ""}" style=${n ? "inset:0" : g}>
          ${r.map(({ row: t, rowIndex: r, hidden: i, cards: a }) => {
			let o = re * (t.weight ?? 1) / h;
			return o - (t.title && t.showTitle !== !1 && o >= 24 ? 17 : 0), (ne - 4 * Math.max(0, a.length - 1)) / a.length, D`<div
              class="group ${i ? "hidden-item" : ""}"
              style="flex:${t.weight ?? 1}"
            >
              ${t.title && t.showTitle !== !1 ? D`<div
              ...
              >
				...
				let u = this.interaction.freeDrag?.row === r && this.interaction.freeDrag.card === c, d = u && this.interaction.freeDrag.part === "card" ? this.interaction.freeDrag.frame : s.frame, f = (e) => u && this.interaction.freeDrag.part === e ? this.interaction.freeDrag.frame : We(s, e), p = f("title"), ee = f("value"), te = (e) => {
					let t = f(e);
				...
				}, m = n ? (d?.width ?? 50) * this.width / 100 : (ne - 4 * Math.max(0, a.length - 1)) / a.length, re = n ? (d?.height ?? 25) * this.height / 100 : o - (t.title && t.showTitle !== !1 && o >= 24 ? 17 : 0), h = s.source ? this.hass?.states[s.source]?.state ?? "—" : s.text ?? "—", g = Number(h), _ = s.minimum ?? 0, ie = s.maximum ?? 100, v = Number.isFinite(g) && ie > _ ? Math.max(0, Math.min(100, (g - _) / (ie - _) * 100)) : 0, y = this.cardValue(s), ae = !!(s.title && s.showTitle !== !1 && (n || re >= 28)), b = s.titleStyle?.verticalAlign ?? "top", oe = ae && (b === "top" || b === "bottom"), se = s.progress === "bar" ? 14 : 5, x = re - (s.progress === "bar" ? 9 : 0), ce = this.typography.valueFontSize(s, y, m, Math.max(1, x - 17)), le = (s.titleStyle?.fontSize ?? "auto") === "auto" ? Math.max(1, Math.min(x / 2, x - this.typography.fontLineHeight(ce))) : x, S = n ? this.typography.freeFontSize(s.title ?? "", s.titleStyle, p.width * this.width / 100, p.height * this.height / 100, st(s.titleStyle, !0)) : ae ? this.typography.titleFontSize(s, s.title ?? "", m - 10, oe ? le : x, ce) : 13, C = oe && s.titleStyle?.textFlow === "wrap" ? le : oe ? Math.min(le, this.typography.fontLineHeight(S)) : 0, ue = s.progress === "ring" ? Math.min(22, Math.max(12, (x - C) / 4)) : x - C, w = n ? this.typography.freeFontSize(y, s.valueStyle, ee.width * this.width / 100, ee.height * this.height / 100, st(s.valueStyle, s.type === "text")) : this.typography.valueFontSize(s, y, m, ue), de = Ue(s, h), fe = de?.background ?? s.style?.background ?? "", T = de?.foreground ?? s.style?.foreground ?? "", pe = (H[fe] ?? fe) || "#20242d", me = s.backgroundMode ?? (s.transparentBackground ? "transparent" : s.backgroundImage ? "image" : "color"), E = this.imageUrl(s.type === "image" ? s.image : me === "image" ? s.backgroundImage : void 0), he = H[s.style?.accent ?? ""] ?? s.style?.accent ?? "#42a5f5", ge = (H[T] ?? T) || "white", _e = {
					left: "flex-start",
					center: "center",
					right: "flex-end"
				}[s.valueStyle?.horizontalAlign ?? "center"], ve = {
					top: "flex-start",
					middle: "center",
					bottom: "flex-end"
				}[s.valueStyle?.verticalAlign ?? "middle"], O = s.valueStyle?.horizontalAlign ?? "center", k = {
					left: "flex-start",
					center: "center",
					right: "flex-end"
				}[s.titleStyle?.horizontalAlign ?? "left"], ye = {
					top: "flex-start",
					middle: "center",
					bottom: "flex-end"
				}[b], j = 5 + (b === "top" ? C : 0), be = se + (b === "bottom" ? C : 0), xe = n ? te("value") : `top:${j}px;right:5px;bottom:${be}px;left:5px`, Se = n ? te("title") : b === "top" ? `top:0;right:4px;height:${C}px;left:4px` : b === "bottom" ? `right:4px;bottom:${s.progress === "bar" ? 9 : 0}px;height:${C}px;left:4px` : `top:0;right:4px;bottom:${s.progress === "bar" ? 9 : 0}px;left:4px`, M = s.title ? Math.max(0, W(s.title, S) - (n ? p.width * this.width / 100 - 8 : m - 8)) : 0, N = st(s.titleStyle, !0) && M > 0, Ce = Math.max(0, W(y, w) - (n ? ee.width * this.width / 100 - 8 : m - 8)), P = st(s.valueStyle, n && s.type === "text") && Ce > 0, we = n && [
					"default",
					"sans",
					"sans-bold"
				].includes(s.valueStyle?.fontFamily ?? "default") && s.valueStyle?.textFlow !== "wrap" && (!s.valueStyle?.textEffect || s.valueStyle.textEffect === "none") ? D`<mini-display-firmware-text .text=${y} .size=${w} .color=${ge}></mini-display-firmware-text>` : y, Te = de?.foreground ?? s.titleStyle?.foreground ?? ge, Ee = [
					"default",
					"sans",
					"sans-bold"
				].includes(s.titleStyle?.fontFamily ?? "default") && s.titleStyle?.textFlow !== "wrap" && (!s.titleStyle?.textEffect || s.titleStyle.textEffect === "none") ? D`<mini-display-firmware-text .text=${s.title ?? ""} .size=${S} .color=${H[Te] ?? Te}></mini-display-firmware-text>` : s.title, De = D`<div
                    class="value ${P ? "marquee" : ""}"
                    ${lt(P ? s.valueStyle?.marqueeEffect === "loop" ? W(y, w) + 24 : Ce : 0, s.valueStyle, y, this.refreshRateHz)}
                    .draggable=${this.interactive}
                    style=${`font-family:sans-serif;font-size:${w}px;font-weight:700;${this.typography.textEffectCss(s.valueStyle)};${this.typography.textFlowCss(s.valueStyle, w)}`}
                    @click=${(e) => {
					e.stopPropagation(), this.emit("preview-select", {
						kind: "value",
						row: r,
                  ...
                  >
                    ...
                    ${P && s.valueStyle?.marqueeEffect === "loop" ? D`<span class="marquee-copy" aria-hidden="true">${we}</span>` : A}
                  </div>`, Oe = n && (e.transparentCards || me === "transparent") && !s.graph && s.type !== "image";
				return D`<div
                    class="card ${Oe ? "text-only-frame" : ""} ${s.valueStyle?.textFlow === "overflow" || s.titleStyle?.textFlow === "overflow" ? "flow-overflow" : ""} ${u ? "moving" : ""} ${s.type === "image" ? "image-card" : ""} ${this.interactive ? "interactive" : ""} ${l && !i ? "hidden-item" : ""}"
                    ...
                    style=${`${n && d ? `left:${d.x}%;top:${d.y}%;width:${d.width}%;height:${d.height}%;` : ""}${e.transparentCards || me === "transparent" ? "background:transparent" : `background-color:${pe}`};${!e.transparentCards && E ? `background-image:url(${E});background-size:${s.imageFit === "contain" ? "contain" : s.imageFit === "stretch" ? "100% 100%" : "cover"};background-position:center;background-repeat:no-repeat;` : ""}color:${ge}`}
                    @click=${(e) => {
					e.stopPropagation(), this.emit("preview-select", {
						kind: "card",
						row: r,
                  ...
                  >
                    ${s.graph ? D`<mini-display-graph-preview .graph=${s.graph} .source=${s.source ?? ""} .series=${this.historySeries} .width=${m} .height=${re}></mini-display-graph-preview>` : A}
                    ${n && this.interactive && !Oe ? D`<button class="resize-handle" aria-label="Resize item" @click=${(e) => e.stopPropagation()}></button>` : A}
                    ${s.title && s.showTitle !== !1 ? D`<small
                            data-part=${n ? "title" : A}
                            style=${`${Se};overflow:${s.titleStyle?.textFlow === "overflow" ? "visible" : "hidden"};align-items:${ye};justify-content:${N ? "flex-start" : k};text-align:${N ? "left" : s.titleStyle?.horizontalAlign ?? "left"};font-size:${S}px;line-height:${this.typography.fontLineHeight(S)}px`}
                            ><span
                              class="card-label ${N ? "marquee" : ""}"
                              ${lt(N ? s.titleStyle?.marqueeEffect === "loop" ? W(s.title ?? "", S) + 24 : M : 0, s.titleStyle, s.title ?? "", this.refreshRateHz)}
                              aria-label=${s.title ?? ""}
                              style=${`${this.typography.textEffectCss(s.titleStyle)};${this.typography.textFlowCss(s.titleStyle, S)}`}
                              .draggable=${this.interactive}
                              @click=${(e) => {
					e.stopPropagation(), this.emit("preview-select", {
						kind: "title",
					...
					card: c
                              ...
                              @dragend=${() => this.interaction.stopDrag()}
                              ><span class="marquee-copy">${Ee}</span>
                              ${N && s.titleStyle?.marqueeEffect === "loop" ? D`<span class="marquee-copy" aria-hidden="true">${Ee}</span>` : A}</span
                            >${n && this.interactive ? D`<button class="resize-handle" aria-label="Resize title"></button>` : A}</small
                          >` : null}${s.type === "weather" ? D`<div class="value-wrap" data-part=${n ? "value" : A} style=${xe}><mini-display-weather-preview style="position:absolute;inset:0" .hass=${this.hass} .card=${s} .signature=${JSON.stringify([s.source, s.weather])}></mini-display-weather-preview>${n && this.interactive ? D`<button class="resize-handle" aria-label="Resize value"></button>` : A}</div>` : s.type === "image" || s.type === "chart" ? A : s.progress === "ring" ? D`<div class="ring-stack" data-part=${n ? "value" : A} style=${xe}>
                              <div
                                class="ring"
                                style=${`background:conic-gradient(${he} ${v}%,#3d424e 0);--ring-bg:${pe}`}
                              ></div>
                              ${De}
                              ${n && this.interactive ? D`<button class="resize-handle" aria-label="Resize value"></button>` : A}
                            </div>` : D`<div
                              class="value-wrap"
                              data-part=${n ? "value" : A}
                              style=${`${xe};align-items:${ve};justify-content:${P ? "flex-start" : _e};text-align:${O};${P ? "overflow:hidden;padding-inline:4px" : ""}`}
                            >
                              ${De}
                              ${n && this.interactive ? D`<button class="resize-handle" aria-label="Resize value"></button>` : A}
                            </div>`}${this.interaction.positionGrid(r, c)}${s.type !== "image" && s.progress === "bar" ? D`<div class="bar"><i style=${`width:${v}%;background:${he}`}></i></div>` : null}
                  </div>`;
			})}
              </div>
            </div>`;
...
z([L({ attribute: !1 })], G.prototype, "dashboard", void 0), z([L({ attribute: !1 })], G.prototype, "hass", void 0), z([L({ attribute: !1 })], G.prototype, "assets", void 0), z([L({ type: Number })], G.prototype, "page", void 0), z([L({ type: Boolean })], G.prototype, "autoRotate", void 0), z([L({ type: Number })], G.prototype, "width", void 0), z([L({ type: Number })], G.prototype, "height", void 0), z([L({ type: Number })], G.prototype, "refreshRateHz", void 0), z([L()], G.prototype, "displayId", void 0), z([L({ type: Boolean })], G.prototype, "interactive", void 0), z([L({ type: Boolean })], G.prototype, "showHidden", void 0), z([R()], G.prototype, "now", void 0), z([R()], G.prototype, "autoPage", void 0), z([R()], G.prototype, "historySeries", void 0), customElements.get("mini-display-preview") || customElements.define("mini-display-preview", G);
//#endregion
//#region src/json-view.ts
var Et = /"(?:\\u[\da-fA-F]{4}|\\[^u]|[^\\"])*"|-?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?|\b(?:true|false|null)\b/g, Dt = (e) => {
	let t = JSON.stringify(e, null, 2), n = [], r = 0;
	for (let e of t.matchAll(Et)) {
		let i = e.index, a = e[0];
		n.push(t.slice(r, i));
		let o = "number";
		a.startsWith("\"") ? o = /^\s*:/.test(t.slice(i + a.length)) ? "key" : "string" : a === "true" || a === "false" ? o = "boolean" : a === "null" && (o = "null"), n.push(D`<span class="json-${o}">${a}</span>`), r = i + a.length;
	}
	...
	selectTab(e, t) {
		this.tabs = {
			...this.tabs,
			[e]: t
		}, Ot(this, "schema-view-changed", Object.values(this.tabs).includes("schema"));
	}
	static {
		this.styles = o`
    :host {
  ...
  `;
	...
	renderDisplay(e) {
      ...
      <ha-card
        ...
        @click=${() => Ot(this, "display-selected", e.config_entry_id)}
      >
        <div class="tabs">
          <div class="tab-list" role="tablist">
            ${["preview", "schema"].map((t) => D`
              <button
          ...
          <button
            ...
            ?disabled=${!r && !a}
            @click=${(t) => {
			t.stopPropagation(), Ot(this, "preview-toggle", e);
		}}
          >
            <ha-icon
        ...
        ${t ? D`
                ${o === "preview" ? D`
                  ...
                  ></mini-display-preview>
                ` : D`<pre @click=${(e) => e.stopPropagation()}><code>${Dt(t.pages[n])}</code></pre>`}
                ${t.pages.length > 1 ? D`
                  <nav>
                    <button
                      class="icon"
                      ...
                      @click=${(t) => {
			t.stopPropagation(), Ot(this, "preview-page", {
				displayId: e.config_entry_id,
				delta: -1
			});
		}}
        ...
        ${!i && t ? D`<ha-button
                ...
                @click=${(t) => {
			t.stopPropagation(), Ot(this, "scene-activate", e);
		}}
...
z([L({ attribute: !1 })], K.prototype, "hass", void 0), z([L({ attribute: !1 })], K.prototype, "displays", void 0), z([L({ attribute: !1 })], K.prototype, "dashboards", void 0), z([L({ attribute: !1 })], K.prototype, "pages", void 0), z([L({ attribute: !1 })], K.prototype, "dirtyDisplays", void 0), z([L({ attribute: !1 })], K.prototype, "assets", void 0), z([L()], K.prototype, "selectedDisplayId", void 0), z([L()], K.prototype, "selectedSceneId", void 0), z([L()], K.prototype, "selectedSceneName", void 0), z([R()], K.prototype, "showHidden", void 0), z([R()], K.prototype, "tabs", void 0), K = z([I("mini-display-preview-list")], K);
//#endregion
          ...
          ${this.scenes.map((e) => D`
              ...
              >
                ...
                >
                  ...
                  <span>${e.name}</span>
                  ${e.is_default ? D`<ha-icon class="default" icon="mdi:star" title="Default scene"></ha-icon>` : A}
                </button>
                ${e.id === this.selectedSceneId ? D`
                        ...
                        >
                          ...
                          >
                            ...
                            ${e.is_default ? A : D`<button @click=${() => q(this, "scene-default")}>Set as default</button>`}
                            ${e.is_default ? A : D`<button class="danger" @click=${() => q(this, "scene-delete")}>Delete</button>`}
                          </div>
                        </details>
                      ` : A}
              </div>
...
z([L({ attribute: !1 })], J.prototype, "displays", void 0), z([L({ attribute: !1 })], J.prototype, "scenes", void 0), z([L()], J.prototype, "selectedDisplayId", void 0), z([L()], J.prototype, "selectedSceneId", void 0), z([L()], J.prototype, "section", void 0), z([L({ type: Number })], J.prototype, "imageCount", void 0), z([L()], J.prototype, "form", void 0), z([L()], J.prototype, "sceneName", void 0), J = z([I("mini-display-scene-sidebar")], J);
//#endregion
//#region node_modules/lit-html/directives/live.js
var kt = Xe(class extends Ze {
	constructor(e) {
		if (super(e), e.type !== V.PROPERTY && e.type !== V.ATTRIBUTE && e.type !== V.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
	...
	update(e, [t]) {
		...
		if (e.type === V.PROPERTY) {
			...
			if (!!t === n.hasAttribute(r)) return k;
		} else if (e.type === V.ATTRIBUTE && n.getAttribute(r) === t + "") return k;
		return Ye(e), t;
	}
}), At = {
	...
	"less_than_or_equal",
	"range"
], Mt = new Set(jt.filter((e) => e !== "range")), Nt = [
	"equals",
	"not_equals",
	"starts_with",
	"ends_with",
	"contains"
], Pt = ["available", "unavailable"], Ft = (e) => jt.includes(e), It = () => ({
	rules: [{
		id: "rule_a",
		source: "entity",
		entity: "",
	...
	"#f4511e",
	"#7cb342"
], Y = (e) => e.replace("rule_", "").toUpperCase(), Rt = (e) => Lt[Math.max(0, e.charCodeAt(e.length - 1) - 97) % Lt.length], zt = (e, t, n) => {
	e.dispatchEvent(new CustomEvent(t, {
		detail: n,
		bubbles: !0,
		composed: !0
	...
	constructor(...e) {
		super(...e), this.targetName = "", this.targetKind = "card", this.draft = It(), this.advanced = !1, this.draftInitialized = !1;
	}
	static {
		this.styles = o`
  ...
  `;
	...
	willUpdate() {
		this.draftInitialized || (this.draftInitialized = !0, this.draft = structuredClone(this.value ?? It()), !this.value && this.canUseCardValue && (this.draft.rules[0].source = "card", this.card?.type === "number" && (this.draft.rules[0].operator = "range")));
	}
	disconnectedCallback() {
	...
	render() {
      ...
      <ha-card role="dialog" aria-modal="true" aria-labelledby="visibility-title" @click=${(e) => e.stopPropagation()}>
        ...
        <main>
          ...
          ${!this.advanced && this.draft.rules.length > 1 ? D`<label>Match<select .value=${kt(this.draft.expression.operator)} @change=${(e) => this.updateGroup([], { operator: e.target.value })}><option value="and">All conditions</option><option value="or">Any condition</option></select></label>` : A}
          ${!this.advanced && this.hasAdvancedLogic ? D`<p class="error">Nested or inverted logic is active. Use Advanced mode to edit it.</p>` : A}
          ...
          ${this.advanced ? D`<section><div class="section-head"><h3>Logic</h3></div><div class="logic">${this.renderGroup(this.draft.expression, [])}</div></section>` : A}
          ${e ? D`<p class="error" role="alert">${e}</p>` : A}
        </main>
        <footer class="actions"><ha-button @click=${() => zt(this, "visibility-clear")}>Always visible</ha-button><div class="right"><ha-button @click=${() => zt(this, "visibility-cancel")}>Cancel</ha-button><ha-button .disabled=${!!e} @click=${this.save}>Save</ha-button></div></footer>
      </ha-card>`;
	}
	get canUseCardValue() {
	...
	renderRule(e, t) {
		let n = e.source === "entity", r = Nt.includes(e.operator), i = Mt.has(e.operator);
		return D`<article class="rule">
      <div class="rule-head">
        <span class="rule-marker" style=${`background:${Rt(e.id)}`}>${Y(e.id)}</span>
        <label>Value source<select .value=${kt(e.source)} @change=${(e) => this.changeSource(t, e.target.value)}>${this.canUseCardValue ? D`<option value="card">This card</option>` : A}<option value="entity">${this.canUseCardValue ? "Another entity" : "Entity"}</option></select></label>
      ...
      <div class="rule-fields">
        <label>Comparison<select .value=${kt(e.operator)} @change=${(e) => this.changeOperator(t, e.target.value)}>${this.operatorOptions(e).map((e) => D`<option value=${e}>${At[e]}</option>`)}</select></label>
        ${n ? D`<div class="entity-source"><ha-form .hass=${this.hass} .data=${{ entity: e.entity ?? "" }} .schema=${[{
			name: "entity",
			required: !0,
			selector: { entity: this.entitySelector(e) }
		}]} .computeLabel=${() => "Entity"} @value-changed=${(e) => this.updateRule(t, { entity: e.detail.value.entity })}></ha-form>${this.currentValue(e)}</div>` : D`<div class="entity-source">${this.currentValue(e)}</div>`}
        ${e.operator === "range" ? D`<div class="range">${this.numberField("From", e.minimum, (e) => this.updateRule(t, { minimum: e }))}${this.numberField("To", e.maximum, (e) => this.updateRule(t, { maximum: e }))}</div>` : i ? this.numberField("Value", e.value, (e) => this.updateRule(t, { value: e })) : r ? this.matchField(e, t) : A}
      </div>
    </article>`;
	}
	numberField(e, t, n) {
		return D`<label>${e}<input type="number" .value=${t === void 0 ? "" : String(t)} @input=${(e) => {
			let t = e.target.value;
			n(t === "" ? void 0 : Number(t));
		}}></label>`;
	}
	renderGroup(e, t) {
		return D`<div class="group ${t.length ? "nested" : ""}">
      <div class="group-head"><label>Group logic<select .value=${kt(e.operator)} @change=${(e) => this.updateGroup(t, { operator: e.target.value })}><option value="and">All must match (AND)</option><option value="or">Any may match (OR)</option></select></label><label class="invert"><input type="checkbox" .checked=${e.negate === !0} @change=${(e) => this.updateGroup(t, { negate: e.target.checked })}>Invert result</label></div>
	...
	renderExpression(e, t, n, r) {
		return e.type === "group" ? D`<div class="logic-child"><span class="logic-index">${n + 1}</span>${this.renderGroup(e, t)}${this.moveButtons(t, n, r)}<button class="icon danger" ?disabled=${r === 1} aria-label="Remove group" @click=${() => this.removeExpression(t)}><ha-icon icon="mdi:delete-outline"></ha-icon></button></div>` : D`<div class="logic-child"><span class="logic-index">${n + 1}</span><div><div class="rule-reference"><span class="rule-marker" style=${`background:${Rt(e.ruleId)}`}>${Y(e.ruleId)}</span><label>Condition<select .value=${kt(e.ruleId)} @change=${(n) => this.updateExpression(t, {
			...e,
			ruleId: n.target.value
		})}>${this.draft.rules.map((e) => D`<option value=${e.id}>Condition ${Y(e.id)}</option>`)}</select></label></div><label class="invert"><input type="checkbox" .checked=${e.negate === !0} @change=${(n) => this.updateExpression(t, {
			...e,
	...
	moveButtons(e, t, n) {
		return D`<div class="move"><button class="icon" ?disabled=${t === 0} aria-label="Move up" @click=${() => this.moveExpression(e, -1)}><ha-icon icon="mdi:chevron-up"></ha-icon></button><button class="icon" ?disabled=${t === n - 1} aria-label="Move down" @click=${() => this.moveExpression(e, 1)}><ha-icon icon="mdi:chevron-down"></ha-icon></button></div>`;
	}
	updateRule(e, t) {
		this.draft = {
			...this.draft,
	...
	changeSource(e, t) {
		...
		if (t === "card" && this.card?.type === "number" && ![...jt, ...Pt].includes(n.operator)) {
			this.changeOperator(e, "range"), this.updateRule(e, { source: t });
			return;
		}
		if (t === "card" && this.card?.type !== "number" && Ft(n.operator)) {
	...
	operatorOptions(e) {
		return e.source === "card" ? this.card?.type === "number" ? [...jt, ...Pt] : [...Nt, ...Pt] : Object.keys(At);
	}
	entitySelector(e) {
	...
	currentValue(e) {
		if (e.source === "entity" && !e.entity) return D`<div class="current-value">Select an entity to see its current value.</div>`;
		if (e.source === "card" && this.card?.type === "text" && !this.card.source) return D`<div class="current-value"><span>Current value: </span><strong>${this.card.text ?? ""}</strong></div>`;
		let t = e.source === "card" ? this.card?.source : e.entity, n = t ? this.hass?.states[t] : void 0;
		if (!n) return D`<div class="current-value unavailable"><span>Current value: </span><strong>not available</strong></div>`;
		let r = typeof n.attributes?.unit_of_measurement == "string" ? ` ${n.attributes.unit_of_measurement}` : "";
		return D`<div class="current-value ${["unknown", "unavailable"].includes(n.state) ? "unavailable" : ""}"><span>Current value: </span><strong>${n.state}${r}</strong></div>`;
	}
	knownValues(e) {
	...
	matchField(e, t) {
		...
		if (n.length) {
			...
			return D`<label>Value<select .value=${kt(e.match ?? "")} @change=${(e) => this.updateRule(t, { match: e.target.value })}><option value="" disabled>Select value</option>${r.map((e) => D`<option value=${e}>${e}</option>`)}</select></label>`;
		}
		let r = this.sourceState(e)?.state;
		return D`<label>Value<input maxlength="64" placeholder=${r ? `Current: ${r}` : "Value"} .value=${e.match ?? ""} @input=${(e) => this.updateRule(t, { match: e.target.value })}></label>`;
	}
	changeOperator(e, t) {
		...
		t === "range" ? (r.minimum = n.minimum, r.maximum = n.maximum) : Mt.has(t) ? r.value = n.value : Pt.includes(t) || (r.match = n.match ?? "");
		let i = r.entity ? this.hass?.states[r.entity] : void 0;
		r.source === "entity" && r.entity && i && !Pt.includes(t) && this.isNumericState(r.entity, i) !== Ft(t) && delete r.entity, this.draft = {
			...this.draft,
	...
	get validationError() {
		for (let e of this.draft.rules) {
			...
			if (Mt.has(e.operator) && !Number.isFinite(e.value)) return `Condition ${Y(e.id)} needs a numeric value.`;
			if (Nt.includes(e.operator) && !e.match?.length) return `Condition ${Y(e.id)} needs a value.`;
		}
	}
	save() {
		...
		zt(this, "visibility-save", e);
	}
};
z([L({ attribute: !1 })], X.prototype, "hass", void 0), z([L()], X.prototype, "targetName", void 0), z([L()], X.prototype, "targetKind", void 0), z([L({ attribute: !1 })], X.prototype, "card", void 0), z([L({ attribute: !1 })], X.prototype, "value", void 0), z([R()], X.prototype, "draft", void 0), z([R()], X.prototype, "advanced", void 0), X = z([I("mini-display-visibility-dialog")], X);
//#endregion
...
var Bt = (e) => {
	...
	let l = c.getImageData(0, 0, a, o).data, u = new Uint8Array(a * o * 2), d = new DataView(u.buffer);
	for (let e = 0, t = 0; e < l.length; e += 4, t += 2) {
	...
	constructor(...e) {
		super(...e), this.assets = [], this.displayId = "", this.label = "Image", this.value = "", this.uploadOnly = !1, this.maximumWidth = 240, this.maximumHeight = 240, this.busy = !1, this.error = "", this.upload = async (e) => {
			...
			if (n && this.hass && this.displayId) {
				...
				try {
					let e = await Ut(n, Math.max(1, this.maximumWidth), Math.max(1, this.maximumHeight));
  ...
  `;
	...
	render() {
      ...
      <div class="picker">
        ${e?.preview ? D`<img class="thumb" src=${e.preview} alt="" />` : D`<div class="thumb empty"><ha-icon icon="mdi:image-outline"></ha-icon></div>`}
        <div>
          ${this.uploadOnly ? D`<strong>Add a new image</strong><br /><small
                  ...
                  >${e ? D`<small>${Math.ceil(e.bytes / 1024)} KB on display</small>` : A}`}
        </div>
        <div class="actions">
          ${e && !this.uploadOnly ? D`<button
                  class="detach"
                  title="Detach image"
      ...
      ${this.error ? D`<div class="error" role="alert">${this.error}</div>` : A}
    </div>`;
	}
	select(e) {
...
z([L({ attribute: !1 })], Z.prototype, "hass", void 0), z([L({ attribute: !1 })], Z.prototype, "assets", void 0), z([L()], Z.prototype, "displayId", void 0), z([L()], Z.prototype, "label", void 0), z([L()], Z.prototype, "value", void 0), z([L({ type: Boolean })], Z.prototype, "uploadOnly", void 0), z([L({ type: Number })], Z.prototype, "maximumWidth", void 0), z([L({ type: Number })], Z.prototype, "maximumHeight", void 0), z([R()], Z.prototype, "busy", void 0), z([R()], Z.prototype, "error", void 0), Z = z([I("mini-display-image-field")], Z);
//#endregion
...
var Q = class extends F {
  ...
  `;
	...
	renderAsset(e) {
      ...
      <div class="preview">
        ${e.preview ? D`<img src=${e.preview} alt=${e.name} />` : D`<ha-icon icon="mdi:image-outline"></ha-icon>`}
      </div>
      <div class="details">
        <div>
...
z([L({ attribute: !1 })], Q.prototype, "hass", void 0), z([L({ attribute: !1 })], Q.prototype, "assets", void 0), z([L()], Q.prototype, "displayId", void 0), z([L()], Q.prototype, "displayName", void 0), z([L({ type: Number })], Q.prototype, "maximumWidth", void 0), z([L({ type: Number })], Q.prototype, "maximumHeight", void 0), z([R()], Q.prototype, "busy", void 0), z([R()], Q.prototype, "error", void 0), z([R()], Q.prototype, "pendingDelete", void 0), Q = z([I("mini-display-image-manager")], Q);
//#endregion
...
var Wt = class extends F {
  ...
  `;
	...
	numeric(e, t, n, r, i) {
		return D`<label>${e}<input type="number" min=${r} max=${i} .value=${n === void 0 ? "" : String(n)} placeholder="Auto" @change=${(e) => {
			let n = e.target.value;
			this.patchGraph({ [t]: n === "" ? void 0 : Math.min(i, Math.max(r, Number(n))) });
		}}></label>`;
	}
	select(e, t, n, r) {
		return D`<label>${e}<select aria-label=${e} @change=${(e) => this.patchGraph({ [t]: e.target.value })}>${r.map(([e, t]) => D`<option value=${e} .selected=${n === e}>${t}</option>`)}</select></label>`;
	}
	render() {
		let e = this.card.graph;
		return D`
      ${this.card.type === "chart" ? A : D`<label class="check"><input type="checkbox" .checked=${!!e} @change=${(e) => this.dispatchEvent(new CustomEvent("graph-changed", {
			detail: e.target.checked ? Re() : void 0,
			bubbles: !0,
			composed: !0
...
z([L({ attribute: !1 })], Wt.prototype, "card", void 0), z([L({ attribute: !1 })], Wt.prototype, "hass", void 0), Wt = z([I("mini-display-graph-editor")], Wt);
//#endregion
...
var Gt = class extends F {
  ...
  `;
	...
	choice(e, t, n, r) {
      ...
      >
        ${n.map(([e, n]) => D`<option value=${e} ?selected=${(this.settings[t] ?? r) === e}>${n}</option>`)}
      </select></label
    >`;
	}
	number(e, t, n, r, i) {
	...
	render() {
        ...
        ${(e.period ?? "current") === "current" ? A : D` ${this.number(e.period === "daily" ? "Start day (0 today, 1 tomorrow)" : e.period === "hourly" ? "Hour offset (0 first available)" : "Period offset (0 current)", "offset", 0, 0, 14)}
...
z([L({ attribute: !1 })], Gt.prototype, "settings", void 0), Gt = z([I("mini-display-weather-editor")], Gt);
//#endregion
...
var $ = class extends F {
  ...
  `;
	...
	checkbox(e, t, n, r = !1, i = "") {
		return D`<label class="check" title=${i}
      ><input
        type="checkbox"
        .checked=${t}
        ?disabled=${r}
	...
	segmented(e, t, n, r, i = !1) {
      ...
      <div class="segmented" role="radiogroup" aria-label=${e}>
        ${n.map((e) => D`<button class="segment ${e.value === t ? "active" : ""}" role="radio" aria-checked=${e.value === t} title=${e.label} ?disabled=${i} @click=${() => {
			i || r(e.value);
		}}>${e.icon ? D`<ha-icon icon=${e.icon}></ha-icon>` : A}<span>${e.label}</span></button>`)}
      </div>
    </div>`;
	}
	...
	textLayoutControls(e, t, n, r) {
		return D`<div class="text-layout-controls">
	...
	textEffectEditor(e, t) {
      ...
      <div class="grid effect-grid">
        ...
        ${n === "none" ? A : D`<mini-display-color-field
                  label="Effect color"
			...
			t.effectThickness = e, this.changed();
                ...
                ${n === "shadow" ? D`${this.numberField("Horizontal offset", t.effectOffsetX, 2, -6, 6, (e) => {
	...
	appearanceEditor(e) {
      ...
      ${e.type === "image" ? A : D`<section class="appearance-section">
			...
			i.fontFamily = e, this.changed();
              ...
              ${t ? A : this.select("Font size", i.fontSize ?? "auto", [
			"auto",
			"small",
			"medium",
			"large",
      ...
      ${s ? D`<section class="appearance-section">
			...
			a.fontFamily = e, this.changed();
              ...
              ${t ? A : this.select("Font size", a.fontSize ?? "auto", [
			"auto",
			"small",
			"medium",
			"large",
	...
	valueMappingsEditor(e) {
		if (e.type !== "number" && e.type !== "text") return A;
	...
	cardSettings(e, t, n) {
      ...
      <div class="card-head">
        <div class="card-title">
          ...
          >${e.title?.trim() && e.showTitle === !1 ? D`<span class="condition-mark"><ha-icon icon="mdi:eye-off-outline"></ha-icon>Title hidden</span>` : A}${e.visibility ? D`<span class="condition-mark"><ha-icon icon="mdi:eye-settings-outline"></ha-icon>Conditional</span>` : A}
        </div>
        ${this.menu(D`<button
              @click=${() => {
      ...
      <nav class="card-section-tabs" aria-label="Card settings sections">
        ${[
            ...
            >
              <ha-icon icon=${n}></ha-icon><span>${t}</span>${e === "rules" && a ? D`<span class="section-count">${a}</span>` : A}
            </button>`)}
      </nav>
      <div class="card-pane" role="tabpanel">
        ${this.cardSection === "content" ? D`
			...
			Object.keys(e).forEach((t) => delete e[t]), Object.assign(e, Le(t)), n && (e.frame = n), r && (e.titleFrame = r), i && (e.valueFrame = i), this.changed();
		})}
			...
			this.dashboard?.pages[this.pageIndex]?.layout === "free" && Ge(e), e.showTitle = t, this.changed();
                ...
                ${e.type === "image" ? D`<section class="settings-group">
                        <div class="settings-heading">
			...
			"chart",
			"weather"
		].includes(e.type) ? D`<section class="settings-group">
                        <div class="settings-heading">
                        ...
                        <div class="grid">
                          ${this.entity(e)}
                          ${e.type === "weather" ? D`<mini-display-weather-editor style="grid-column:1/-1" .settings=${e.weather ?? {}}
                            @weather-changed=${(t) => {
			e.weather = t.detail, this.changed();
		}}></mini-display-weather-editor>` : A}
                          ${e.type === "number" ? D`${this.field("Unit", e.unit, (t) => {
		...
		})}${e.progress && e.progress !== "none" ? D`${this.field("Minimum", e.minimum, (t) => {
			e.minimum = Number(t), this.changed();
		}, "number")}${this.field("Maximum", e.maximum, (t) => {
			e.maximum = Number(t), this.changed();
		}, "number")}` : A}` : A}
                          ${e.type === "text" ? D`${this.field("Static text", e.text, (t) => {
			e.text = t, this.changed();
		})}${this.field("Unit", e.unit, (t) => {
			e.unit = t, this.changed();
		})}` : A}
                          ${e.type === "status" ? D`${this.field("On text", e.onText, (t) => {
	...
	rowEditor(e, t) {
      ...
      <div class="row-head">
        <div class="row-title">
          ${this.editingRowTitle === t ? D`<input
          ...
          >${e.visibility ? D`<span class="condition-mark"><ha-icon icon="mdi:eye-settings-outline"></ha-icon>Conditional</span>` : A}
        </div>
        ${this.menu(D`<button @click=${() => this.openVisibility("row", t)}>
              Visibility</button
            ><button
              @click=${() => {
      ...
      <nav class="card-tabs" aria-label=${`Cards in row ${t + 1}`}>
		...
		})}${e.cards.length < 3 ? D`<button
                class="icon-button"
                title="Add card"
                aria-label="Add card"
                @click=${() => {
			e.cards.push(Le()), this.selected = {
				row: t,
      ...
      ${this.selected?.row === t ? this.cardSettings(e.cards[this.selected.card], t, this.selected.card) : A}
    </section>`;
	}
	setLayout(e) {
		let t = this.dashboard.pages[this.pageIndex];
	...
	freeEditor(e) {
      ...
      <nav class="tabs" aria-label="Add item">${[
			...
			"clock",
			"status"
		].map((e) => D`<button class="tab" @click=${() => r(e)}><ha-icon icon="mdi:plus"></ha-icon>${e}</button>`)}</nav>
      <nav class="card-tabs" aria-label="Items">${t.map(({ card: e, ri: t, ci: n }) => D`<button class="tab ${this.selected?.row === t && this.selected.card === n ? "active" : ""}" @click=${() => this.selected = {
			row: t,
			card: n
		}}>${this.cardName(e)}</button>`)}</nav>
      ${n?.frame ? D`<div class="grid compact-grid">${[
			"x",
			"y",
			"width",
			"height"
		...
		}))}</div><div class="tabs"><button class="tab" @click=${() => i(-1)}>Send backward</button><button class="tab" @click=${() => i(1)}>Bring forward</button></div>` : A}
      ${n && this.selected ? this.cardSettings(n, this.selected.row, this.selected.card) : A}
    </section>`;
	}
	renderEditor() {
      ...
      <ha-card class="editor-card">
        ...
        ${t && e ? D`
                <div class="editor-content">
                  <nav class="tabs" aria-label="Dashboard pages">
                    ${e.pages.map((e, t) => D`
                        ...
                        >
                          ${e.enabled === !1 ? D`<ha-icon icon="mdi:eye-off-outline"></ha-icon>` : A}${e.title || e.id}
                        </button>
                      `)}
                    <button
                      class="icon-button"
                      ...
                      title="Add page"
                      @click=${() => {
			e.pages.push(Be(e.pages.length + 1)), this.pageIndex = e.pages.length - 1, this.previewPages = {
				...this.previewPages,
				[this.selectedDisplayId]: this.pageIndex
			}, this.selected = {
				row: 0,
			...
			icon: "mdi:vector-square"
                  ...
                  ${t.layout !== "free" && t.rows.length < 6 ? D`<button
                          class="add-button"
                          @click=${() => {
			t.rows.push(ze()), this.changed();
		}}
                        >
                          Add row
                        </button>` : A}
	...
	render() {
		...
		if (this.displays.length === 0) return D`<ha-card class="empty"
...
z([L({ attribute: !1 })], $.prototype, "hass", void 0), z([R()], $.prototype, "displays", void 0), z([R()], $.prototype, "scenes", void 0), z([R()], $.prototype, "dashboards", void 0), z([R()], $.prototype, "assets", void 0), z([R()], $.prototype, "savedDashboards", void 0), z([R()], $.prototype, "selectedDisplayId", void 0), z([R()], $.prototype, "selectedSceneId", void 0), z([R()], $.prototype, "section", void 0), z([R()], $.prototype, "pageIndex", void 0), z([R()], $.prototype, "cardSection", void 0), z([R()], $.prototype, "editingRowTitle", void 0), z([R()], $.prototype, "previewPages", void 0), z([R()], $.prototype, "schemaViewOpen", void 0), z([R()], $.prototype, "selected", void 0), z([R()], $.prototype, "syncState", void 0), z([R()], $.prototype, "syncMessage", void 0), z([R()], $.prototype, "loaded", void 0), z([R()], $.prototype, "sceneForm", void 0), z([R()], $.prototype, "sceneName", void 0), z([R()], $.prototype, "dirtyDisplays", void 0), z([R()], $.prototype, "visibilityTarget", void 0), z([R()], $.prototype, "confirmation", void 0), $ = z([I("mini-display-editor")], $);
//#endregion
//#region src/panel.ts
...
z([L({ attribute: !1 })], Kt.prototype, "hass", void 0), z([L({ attribute: !1 })], Kt.prototype, "narrow", void 0), z([L({ attribute: !1 })], Kt.prototype, "route", void 0), z([L({ attribute: !1 })], Kt.prototype, "panel", void 0), Kt = z([I("mini-display-panel")], Kt);
//#endregion
